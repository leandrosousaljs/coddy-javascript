...
5.Create a function named getItemDetails that takes an InventoryItem<any> and uses type guards to determine what type of item it is, then prints appropriate information.
...
getItemDetails(findItemById(expandedBookStore, 100));
